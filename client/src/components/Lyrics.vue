...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapActions(['a_spotify','a_index','a_genius']),
            loadFeed(){
        ...
        mounted() {
            ...
            this.loadFeed();
            this.c_genius_lyrics("Michael Jackson Black White", res=> {
                console.log(res);
                if(res) this.a_genius(['set','song',res]);
            });
        }
    }
</script>
